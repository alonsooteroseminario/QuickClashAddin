    ...
    internal class App : IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication application)
        {
            try
            {
                ...
                ContextualHelp contextHelp = new ContextualHelp(ContextualHelpType.Url, "https://www.weclash.xyz/quickclash");
                ...
                button8.ToolTip = "Create 3D Views using Grid location as reference";
                button8.LongDescription = "Create new 3D Views for all the elements closed to a Grid Location and apply a Section Box to each group of Elements.";
                ...
                button9.ToolTip = "Create 3D Views for each Element";
                button9.LongDescription = "Create new 3D Views for each elements and apply a Section Box to each Element.";
            ...
            {
                TaskDialog.Show("Quick Clash Error", ex.ToString());
